...
<!-- Mirrored from adminlte.io/themes/v3/pages/examples/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Sep 2024 10:31:44 GMT -->
...
<head>
    ...
    <script nonce="95191c08-6217-458c-9110-6485c20a2d71">
        try {
            (function(w, d) {
                ! function(j, k, l, m) {
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <input type="text" class="form-control" placeholder="Full name"@error('name') is-invalid @enderror name="name" value="{{ old('name') }}">
                    @error('name')
